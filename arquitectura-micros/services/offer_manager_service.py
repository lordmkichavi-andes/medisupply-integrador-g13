...
image = f"{account}.dkr.ecr.{region}.amazonaws.com/offer-manager:latest"
...
class OfferManagerService(Construct):
    ...
    def _create_task_definition(self):
        """Crear definición de tarea para OfferManager Service"""
        task_role = iam.Role(
            self, "OfferManagerServiceTaskRole",
        ...
        log_group = logs.LogGroup(
            self, "OfferManagerServiceLogGroup",
            log_group_name="/ecs/offer-manager-service",
            retention=logs.RetentionDays.ONE_WEEK
        )
        task_definition = ecs.FargateTaskDefinition(
            self, "OfferManagerServiceTaskDefinition",
            cpu=256,
        ...
        container = task_definition.add_container(
            ...
            environment={
                "SERVICE_NAME": "offer-manager-service",
                "LOG_LEVEL": "INFO",
    ...
    def _create_service(self):
        """Crear servicio ECS para OfferManager Service"""
    ...
    def _create_target_group(self):
        ...
        target_group = elbv2.ApplicationTargetGroup(
            self, "OfferManagerServiceTargetGroup",
            port=8080,
    ...
    def _configure_service_connections(self):
        ...
        self.database.connections.allow_default_port_from(
            ...
            description="Allow OffersService Fargate to connect to PostgreSQL RDS"
        )

    def _configure_alb(self):
        """Configurar ALB para el servicio"""
        self.alb_listener.add_target_groups(
            "OfferManagerServiceTargetGroup",
            target_groups=[self.target_group],
            conditions=[elbv2.ListenerCondition.path_patterns(["/offers*"])],
            priority=210
        )
