...
class ReportsService(Construct):
    ...
    def _create_task_definition(self):
        """Crear definición de tarea para Reports Service"""
        task_role = iam.Role(
            self, "ReportsServiceTaskRole",
        ...
        log_group = logs.LogGroup(
            self, "ReportsServiceLogGroup",
            log_group_name="/ecs/reports-service",
        ...
        container = task_definition.add_container(
            ...
            image=ecs.ContainerImage.from_asset("services/src/reports"),
            logging=ecs.LogDrivers.aws_logs(
                stream_prefix="reports-service",
                log_group=log_group
            ),
            environment={
    ...
    def _create_service(self):
        """Crear servicio ECS para Reports Service"""
