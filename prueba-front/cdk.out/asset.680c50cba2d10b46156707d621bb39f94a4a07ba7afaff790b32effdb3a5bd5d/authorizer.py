...
def perform_security_validations(payload):
    ...
    return validate_cognito_groups_access_with_policies(cognito_groups, current_hour)

def validate_cognito_groups_access_with_policies(cognito_groups, current_hour):
    """
    ...
    for group in cognito_groups:
        if group in GROUP_POLICIES:
            ...
            # Para la prueba E2E, simular validación de país exitosa
            # En producción real, aquí validarías el país desde headers o geolocalización
